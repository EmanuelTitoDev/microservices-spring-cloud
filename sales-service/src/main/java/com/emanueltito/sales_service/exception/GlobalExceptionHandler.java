...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleFeignNotFound(FeignException.NotFound ex) {
        ...
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(
                ...
                "El carrito de compras asociado a la venta no existe en shopping-cart-service");
        problemDetail.setTitle("Carrito No Encontrado");
        problemDetail.setType(URI.create("https://api.emanueltito.com/errors/cart-not-found"));
        problemDetail.setProperty("timestamp", Instant.now());
        return problemDetail;
    }
    ...
    public ProblemDetail handleFeignException(FeignException ex) {
        ...
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(
                HttpStatus.SERVICE_UNAVAILABLE,
                "No se pudo comunicar con el servicio de carritos de compra: " + ex.getMessage());
        problemDetail.setTitle("Servicio No Disponible");
        problemDetail.setType(URI.create("https://api.emanueltito.com/errors/service-unavailable"));
        problemDetail.setProperty("timestamp", Instant.now());
        return problemDetail;
